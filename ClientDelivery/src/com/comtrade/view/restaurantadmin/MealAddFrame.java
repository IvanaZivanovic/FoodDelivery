...
public class MealAddFrame extends JFrame {
	 ...
	 */
	public MealAddFrame(User user, Restaurant restaurant) throws ClassNotFoundException, IOException {
		r = restaurant;
		u = user;
		...
		contentPane = new JPanel(){  
            public void paintComponent(Graphics g) {  
                Image img = Toolkit.getDefaultToolkit().getImage(  
                		MealAddFrame.class.getResource("/images/restaurant-background-3.JPG"));  
		...
		lblName.setBounds(413, 66, 77, 14);
		contentPane.add(lblName);
		
		tfName = new JTextField();
		tfName.setFont(new Font("Tahoma", Font.PLAIN, 14));
		tfName.setBounds(500, 59, 255, 30);
		...
		lblPrice.setBounds(413, 120, 77, 14);
		contentPane.add(lblPrice);
		
		tfPrice = new JTextField();
		tfPrice.setFont(new Font("Tahoma", Font.PLAIN, 14));
		tfPrice.setBounds(500, 113, 255, 30);
		...
		lblCategory.setBounds(278, 242, 83, 14);
		...
		cbCategory.setBounds(374, 239, 157, 20);
		...
		lblCuisine.setBounds(655, 245, 100, 14);
		...
		cbCuisine.setBounds(765, 239, 157, 20);
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				DtoMealRest dtoMealRest = new DtoMealRest();
				dtoMealRest.setCategory(category);
				dtoMealRest.setCuisine(cuisine);
				dtoMealRest.setName(nameString);
				dtoMealRest.setPrice(priceDouble);
				dtoMealRest.setSize(size);
				dtoMealRest.setRestaurant(r);
				
				TransferObject request = TransferObject.create(dtoMealRest, ConstantFc.MEAL, ConstantBl.POST_R_MEAL);
				try {
		...
		btnSave.setBounds(374, 298, 120, 30);
		...
		lblSize.setBounds(413, 182, 80, 14);
		contentPane.add(lblSize);
		
		tfSize = new JTextField();
		tfSize.setFont(new Font("Tahoma", Font.PLAIN, 14));
		tfSize.setBounds(500, 175, 255, 30);
		...
		btnSearch.setBounds(822, 298, 120, 30);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MealRestFrame mrf = null;
				try {
					mrf = new MealRestFrame(user, restaurant);
		...
		ImageIcon reload = new ImageIcon("photos/refresh.JPG");
		...
		btnReload.setBounds(803, 101, 65, 64);
